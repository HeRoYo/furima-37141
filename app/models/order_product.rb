class OrderProduct
  ...
  def save
    ...
    #配送先の情報
    ShippingAddress.create(post_code: post_code, delivery_source_id: delivery_source_id, city: city, house_number: house_number, building: building, phone_number: phone_number, purchase_id: purchase.id)
  end
